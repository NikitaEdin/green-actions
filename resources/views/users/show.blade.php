...
<body style="background-color: whitesmoke;">
                ...
                <div class="d-flex">
                    ...
                    <div class="p-2 flex-grow-1">
                        <div class="d-flex align-items-center">
                            ...
                            {{-- GreenStatus Badge --}}
                            <img class="me-1" src="{{ asset('images/badges/badge-leaf.png') }}" height="25" alt="Badge"
                                class="badge-image">
                    ...
                    <div class="w-100">
                        ...
                        <div>
                            <span class="opacity-25">
                                <img class="me-1" src="{{ asset('images/badges/badge-battery.png') }}" height="25"
                                    alt="Badge" class="badge-image">
    ...
    <section id="action-history">
        <div id="actions-list" class="container" style="margin-top: 5rem;">
           ...
           @livewire('user-action-component', ['userActions' => $user->getUserActions])
