...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            /* Primary button but with color accent*/
            .btn-primary {
            ...
            .btn.btn-primary:focus {
                background-color: rgb(19, 137, 62);
                border-color: transparent;
                color: white;
            }
    
            /* Green line under topic headers*/
            .green-line {
                position: relative;
            ...
            .quote-section {
                background-image: url('../../public/images/divider-bg1.png');
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary sticky-top navbar-light ">
            <div class="container-fluid">
              <a class="navbar-brand" href="#" style="font-weight: 600; color: var(--green-accent);">GreenActions</a>
        ...
        <section class="hero-section text-center">
            <div class="container">
                ...
                <p class="lead">Embark on a journey of sustainability with our community, where every small action
                    contributes to a brighter, greener tomorrow.</p>
                <a href="#greenAction" class="btn btn-primary  btn-lg mt-5">Read More!</a>
            </div>
        </section>
        ...
        <section class="section-padding text-center">
            <div class="container">
                ...
                <p class="lead"> This competitive spirit not only motivates companies to adopt sustainable practices but
                    ...
                    sustainable world.</p>
                <a href="#sustainability" class="btn btn-primary btn-lg mt-5">Read More!</a>
            </div>
        </section>
                ...
                <div class="row mt-5">
                    <div class="col">
                        ...
                        <p class="mt-1" style="text-align: left;">The competition not only sparks innovation but also boosts
                            awareness and motivation, driving companies to lead the way in sustainability through their
                            pioneering green solutions!</p>
                    </div>
                    <div class="col">
        ...
        <section class="section-padding text-center">
            ...
            <p>Gain access to valuable resources and networking<br>opportunities while competing for a the prestigious 'Green Status'!</p>
    
    
            <div class="container text-center mt-5">
                <div class="row justify-content-md-center">
                    <div class="col-md-auto">
                        <div class="card border-2 rounded-5" style="width: 25rem;  border-color: var(--green-accent) !important;">
                            <div class="card-body">
                                ...
                                <div class="row text-start mt-2">
                                    <div>
                                        <span class="h2" style="font-weight: 600;">£99/</span><span class="h5">yr</span>
                                    </div>
                                </div>
