                            ...
                            <form action="{{ route('newTicket') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col mb-3">
                                        ...
                                        <textarea name="ticketContent" style="max-height: 300px;" class="form-control" id="ticketContent" rows="3" >{{ old('ticketContent') }}</textarea>
                                        @error('ticketContent')
                                        <span class="d-block fs-6 text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <button type="submit" name="createTicket" class="mt-3 btn btn-primary">Create Ticket</button>
                            </form>
                             {{-- Success Message --}}
                    ...
                    <div class="mt-5">
                        ...
                        <div class="mx-0 my-2 row py-3" style="outline: 1px solid lightgray;border-radius: 0.5rem;">
                            ...
                            <div class="col-auto align-self-center">
                                <span class="me-5">Status: <span style="color: {{ $ticket->is_open ? 'green' : 'red' }}">{{ $ticket->is_open ? 'OPEN' : 'CLOSED' }}</span></span>
                            </div>
                            <!-- View Ticket Button -->
                            <div class="col-auto align-self-center">
                                <button onclick="window.location.href='{{ route('ticket', ['id' => $ticket->id]) }}'" class="btn btn-primary">View Ticket</button>
